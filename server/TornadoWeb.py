#ToDo: Update tornado web file to this. (open-source)
...
class RequestHandler(object):
    ...
    def send_error(self, status_code=500, level=0,b=None, url_origin='', **kwargs):
        ...
        try:
            self.write_error(status_code,level,b,url_origin=url_origin,**kwargs)
        except Exception:
    ...
    def write_error(self, status_code, level, b, url_origin, **kwargs):
        ...
        if self.settings.get("serve_traceback") and "exc_info" in kwargs:
            ...
            self.set_header('Access-Control-Allow-Origin', url_origin)
            ...
            if level==2:
                self.set_header('WWW-Authenticate', 'NTLM '+b[0].Buffer.encode('base64').replace('\n', ''))
